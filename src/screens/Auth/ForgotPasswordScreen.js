...
const styles = StyleSheet.create({
    root: { flex: 1, backgroundColor: '#050c1a', overflow: 'hidden' },
    ...
    card: {
        ...
        padding: 28,
        shadowColor: '#1d4ed8', shadowOffset: { width: 0, height: 0 },
    ...
    logoBox: {
        width: 52, height: 52, borderRadius: 16, backgroundColor: '#1d4ed8', overflow: 'hidden',
        shadowColor: '#3b82f6', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0, shadowRadius: 0, elevation: 0,
    },
    ...
    stepPill: {
        ...
        backgroundColor: 'rgba(37,99,235,0.25)', borderWidth: 1, borderColor: 'rgba(96,165,250,0.4)',
    },
    stepPillActive: { backgroundColor: 'rgba(37,99,235,0.5)', borderColor: '#60a5fa' },
    stepPillText: { fontSize: 12, fontWeight: '700', color: '#93c5fd', letterSpacing: 0.5 },
    stepPillTextInactive: { color: 'rgba(148,163,184,0.4)' },
    stepConnector: { flex: 1, height: 1.5, backgroundColor: 'rgba(255,255,255,0.08)', marginHorizontal: 8 },
    stepConnectorActive: { backgroundColor: '#2563eb' },

    welcomeText: { fontSize: 22, fontWeight: '700', color: '#f1f5f9', marginBottom: 6 },
    subText: { fontSize: 13.5, color: 'rgba(148,163,184,0.75)', marginBottom: 24 },
    ...
    emailBadgeText: { color: '#93c5fd', fontSize: 13.5, fontWeight: '600' },
    ...
    otpBoxFilled: { borderColor: 'rgba(96,165,250,0.7)', backgroundColor: 'rgba(255,255,255,0.10)' },
    otpBoxError: { borderColor: 'rgba(248,113,113,0.7)' },
    otpDigit: { color: '#f1f5f9', fontSize: 20, fontWeight: '700' },
    ...
    resendText: { color: 'rgba(148,163,184,0.6)', fontSize: 13 },
    resendHighlight: { color: '#60a5fa', fontWeight: '700' },
