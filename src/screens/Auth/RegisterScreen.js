...
const styles = StyleSheet.create({
    ...
    welcomeText: { fontSize: 24, fontWeight: '700', color: '#111827', marginBottom: 6 },
    subText: { fontSize: 13.5, color: '#6b7280', marginBottom: 16 },

    // Step indicator
    stepRow: { flexDirection: 'row', gap: 6, marginBottom: 22 },
    stepDot: { flex: 1, height: 4, borderRadius: 2, backgroundColor: '#f3f4f6' },
    ...
    backHighlight: { color: '#dc2626', fontWeight: '700' },
});